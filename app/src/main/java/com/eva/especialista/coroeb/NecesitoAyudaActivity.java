...
import com.eva.especialista.coroeb.Objetos.Ayuda;
...
public class NecesitoAyudaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.eva.especialista.coroeb.R.layout.activity_necesito_ayuda);
        //TODO: casteos
        btnAyudaEnviar=(Button)findViewById(com.eva.especialista.coroeb.R.id.btnAyudaEnviar);
        tilAyudaNombre=(TextInputLayout)findViewById(com.eva.especialista.coroeb.R.id.tilAyudaNombre);
        tilAyudaApellido=(TextInputLayout)findViewById(com.eva.especialista.coroeb.R.id.tilAyudaApellido);
        tilAyudaCorreo=(TextInputLayout)findViewById(com.eva.especialista.coroeb.R.id.tilAyudaCorreo);
        tilAyudaCelular=(TextInputLayout)findViewById(com.eva.especialista.coroeb.R.id.tilAyudaCelular);
        tilAyudaEnQue=(TextInputLayout)findViewById(com.eva.especialista.coroeb.R.id.tilAyudaEnQue);
        txtAyudaNombre=(EditText)findViewById(com.eva.especialista.coroeb.R.id.txtAyudaNombre);
        txtAyudaApellido=(EditText)findViewById(com.eva.especialista.coroeb.R.id.txtAyudaApellido);
        txtAyudaCorreo=(EditText)findViewById(com.eva.especialista.coroeb.R.id.txtAyudaCoreo);
        txtAyudaCelular=(EditText)findViewById(com.eva.especialista.coroeb.R.id.txtAyudaCelular);
        txtAyudaEnQue=(EditText)findViewById(com.eva.especialista.coroeb.R.id.txtAyudaEnQue);
