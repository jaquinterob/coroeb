...
import com.eva.especialista.coroeb.Objetos.Usuario;
...
public class Registrarse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.eva.especialista.coroeb.R.layout.activity_registrarse);
        ...
        btnRegistrarUsuario = (Button) findViewById(com.eva.especialista.coroeb.R.id.btnResgistrarUsuario);
        txtRegNombre = (EditText) findViewById(com.eva.especialista.coroeb.R.id.txtRegNombre);
        txtRegApellido = (EditText) findViewById(com.eva.especialista.coroeb.R.id.txtRegApellido);
        txtRegCorreo = (EditText) findViewById(com.eva.especialista.coroeb.R.id.txtRegCorreo);
        txtRegPassword = (EditText) findViewById(com.eva.especialista.coroeb.R.id.txtRegContraseña);
        txtConfirmarPassword = (EditText) findViewById(com.eva.especialista.coroeb.R.id.txtRegConfirmarContraseña);
        tilRegNombre = (TextInputLayout) findViewById(com.eva.especialista.coroeb.R.id.tilRegNombre);
        tilRegApellido = (TextInputLayout) findViewById(com.eva.especialista.coroeb.R.id.tilRegApellido);
        tilRegCorreo = (TextInputLayout) findViewById(com.eva.especialista.coroeb.R.id.tilRegCorreo);
        tilRegConfirmarPassword = (TextInputLayout) findViewById(com.eva.especialista.coroeb.R.id.tilRegConfirmarPassword);
        tilRegPassword = (TextInputLayout) findViewById(com.eva.especialista.coroeb.R.id.tilRegPassword);
