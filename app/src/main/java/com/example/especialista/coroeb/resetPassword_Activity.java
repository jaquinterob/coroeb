...
public class resetPassword_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        correo=(EditText)findViewById(R.id.txtRestablecerPasswordCorreo);
        btnEnviar= (Button)findViewById(R.id.btnRestablecerPassword);
        tilCorreo=(TextInputLayout)findViewById(R.id.tilRestablecercontraseñaCorreo);
